// pages/index/more/aircoe/aircoe.js
const app = getApp();
Page({
  ...
  validateData: function () {
    let cue = "";
    if (app.utils.isEmpty(this.data.coValue)) {
      cue += "含氧量不能为空！";
    } else {
      if (!(this.data.coValue > 0 && this.data.coValue <= 21)) {
        cue += "含氧量不能超过取值范围！";
      }
    }
    return cue;
