// pages/index/more/yalinstrument/yalinstrument.js
const app = getApp();
Page({
  ...
  bindKeyInput: function (e) {
    switch (e.currentTarget.id) {
      case 'ylsxsz':
        this.setData({
          ylsxsz: e.detail.value
        })
        break;
      case 'ylxxsz':
        this.setData({
          ylxxsz: e.detail.value
        })
        break;
      case 'ylp':
        this.setData({
  ...
  validateData: function () {
    let cue = "";
    if (app.utils.isEmpty(this.data.ylsxsz)) {
      cue += "压力上限数值不能为空！";
    } 
    if (app.utils.isEmpty(this.data.ylxxsz)) {
      cue += "压力下限数值不能为空！";
    }
    if (app.utils.isEmpty(this.data.ylp)) {
      cue += "压力不能为空！";
    } 
    return cue;
  },
  compute: function (event) {
    ...
    if (app.utils.isEmpty(error)) {
      let Inputs = [];
      Inputs.push(this.data.ylsxsz, this.data.ylxxsz, this.data.ylp);
