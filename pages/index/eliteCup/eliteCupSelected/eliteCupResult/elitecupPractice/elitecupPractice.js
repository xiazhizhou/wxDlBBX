// pages/index/eliteCup/eliteCupSelected/eliteCupResult/elitecupPractice/elitecupPractice.js
const app = getApp();
Page({
  ...
  onLoad: function (options) {
    ...
    this.acquireHistoryClassExam(this.data.wxid);
  },
  switchChange: function (e) {
    this.setData({ switchAnswer: e.detail.value })
  },
  //获取练习模式所有题目
  acquireHistoryClassExam(wxid) {
    app.agriknow.acquireHistoryClassExam({ wxId: wxid })
      .then(res => {
